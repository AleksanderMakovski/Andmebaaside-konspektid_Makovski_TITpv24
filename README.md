...
[Põhimõsted](pohimoisted.md) | [Protseduurid](protseduur.md) | [Trigerid](triger.md) | [HotelliRuumid](hotelliruum.md) | [Kasutajad](kasutajad.md)
...
```sql
INSERT INTO opilane
VALUES ('Aleksander', 'Makovski', '2007-03-05',1,'+37256968322', 'Muraste', 3.5)
INSERT INTO opilane(perenimi,eesnimi,keskmineHinne)
values('Makovski', 'Aleksander', 3.5),
('Mikaelyan', 'Artur', 5.0),
('Pi', 'Totya', 2),
('Kleshj', 'Kostya', 3.1);
```
...
INSERT INTO opilane
VALUES('Anton', 'Chigur', '2000-10-8',1,'+372666228', 'Saku', 4.5, '566777',33);
INSERT INTO opilane
VALUES('Abdul', 'Sasun', '1994-5-7',1,'+372880053', 'Tartu', 4.5, '566777',22);
```
